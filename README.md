...
| ADT7410       | 0.0625/0.0078 °C | **±0.5 °C** | Да       |
...
# │
# └── ADT7410 (высокоточный, 13/16 бит, отдельная карта регистров)
#
#
...
| Версия | Изменения                                           |
|--------|-----------------------------------------------------|
| 1.2.0  | + ADT7410, вынос констант, диагностика `[HW LIMIT]` |
| 1.1.0  | + TMP11X, унифицированные интерфейсы                |
| 1.0.0  | Базовая поддержка LM75/TMP75                        |

# Лицензия
MIT — используйте в коммерческих и открытых проектах.
